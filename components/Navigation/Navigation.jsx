  ...
  return (
    <aside className="bg-primary text-white  p-1 md:p-5 py-12 pr-0 md:pr-0 ">
      ...
      <Image
              ...
              width={160}
              height={160}
              className="object-contain  bg-white border   border-green-400 rounded-lg  mr-4"
            />
      ...
      <nav className="sticky top-3 mt-44">
        ...
        <div className="menuItem fixed bottom-0 flex justify-center items-end py-4 cursor-pointer flex-wrap w-40" onClick={user ? handleSignOut : handleSignIn}>
                        {user ? (
                            <>
