...
def transcribe_mp3_file(mp3_file_path):
    try:
                ...
                "metrics": {
                    ...
                    "properties": {
                            ...
                            "properties": {
                                ...
                                "details": {
                                    ...
                                    "items": {
                                        ...
                                        "required": ["error", "suggested_correction", "context"]
                                    }
                                }
                            },
                            ...
                            "properties": {
                                ...
                                "issues": {
                                    ...
                                    "items": {
                                        ...
                                        "properties": {
                                            "word": {"type": "string"},
                                            "expected_pronunciation": {"type": "string"},
                                            "actual_pronunciation": {"type": "string"},
                                            "timestamp": {"type": "number"}
                                        },
                                        "required": ["word", "expected_pronunciation", "actual_pronunciation", "timestamp"]
                                    }
                                },
                                "excluded_words": {
                                    "type": "array",
                                    "items": {
                                        ...
                                        "required": ["word", "type", "reason"]
                                    }
                                }
                            },
                            "required": ["score", "issues", "excluded_words"]
                        },
                        "pause_patterns": {
                            "type": "object",
                            "properties": {
                                "average_pause_duration": {"type": "number"},
                                "longest_pause": {
                                    "type": "object",
                                    "properties": {
                                    ...
                                    "required": ["duration", "timestamp_start", "timestamp_end"]
                                },
                                "short_pauses": {"type": "integer"}
                            },
                            "required": ["average_pause_duration", "longest_pause", "short_pauses"]
                        },
                        "filler_word_usage": {
                            "type": "object",
                            "properties": {
                        ...
                        "speaking_pace": {
                            ...
                            "required": ["words_per_minute", "variability"]
                        }
                    },
                    "required": ["grammatical_errors", "word_clarity", "phonetic_accuracy", "pause_patterns", "filler_word_usage", "speaking_pace"]
                }
            },
            "required": ["transcription", "metrics"]
        }

        prompt = """
        Analyze the provided audio file for transcription and key speaking metrics. Focus specifically on accurately identifying filler words. Return the analysis in JSON format.
        ...
        6. filler_word_usage:
            Accurately identify common filler words (e.g., "Um", "Uh", "Er", "Ah", "Like", "So", "Well", "Okay", "Right", "Yeah", "Actually", "Basically", "Literally", "Seriously", "Totally", "Honestly", "Obviously", "Clearly", "Really", "Sure", "Alright", "You know", "I mean", "Kind of", "Sort of").
        ...
        7. speaking_pace: Calculate words per minute and comment on pace variability (e.g., 'consistent', 'variable').
        """

        # Generate content with output schema
...
def process_url_list(urls):
    ...
    try:
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=4) as executor:
            ...
            for future in concurrent.futures.as_completed(future_to_file, timeout=6000):
